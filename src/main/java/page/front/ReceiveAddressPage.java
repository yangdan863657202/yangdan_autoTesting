...
public class ReceiveAddressPage extends PageObject {
    public void setReceiveAddress(WebDriver driver)throws PageElementNotException {
        ...
        WebDriverUtil.getElement(driver, ReceiveAddressPageXpath.RECEIVER_INPUT).sendKeys("1");
        ...
        WebDriverUtil.getElement(driver, ReceiveAddressPageXpath.DETAIL_ADDRESS_INPUT).sendKeys("1");
        WebDriverUtil.getElement(driver, ReceiveAddressPageXpath.CELLPHONE_INPUT).sendKeys("13761677814");
        WebDriverUtil.getElement(driver, ReceiveAddressPageXpath.FIXED_NUMBER_INPUT).sendKeys("1");
        WebDriverUtil.getElement(driver, ReceiveAddressPageXpath.ADDRESS_ALIAS_INPUT).sendKeys("1");

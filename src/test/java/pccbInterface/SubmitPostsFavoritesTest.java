 ...
 * Created by yangdan
 */
public class SubmitPostsFavoritesTest {
    @Test
    public static void submitPostsFavoritesTest() throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://www.pccb.com/appforum/submit_posts_favorites");
            ...
            list.add(new BasicNameValuePair("sign_key", Md5.md5( "82044"+"41301"+"pccbSubmitPostsFavorites" )));

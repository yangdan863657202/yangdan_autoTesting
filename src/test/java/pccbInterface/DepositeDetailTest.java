 ...
 * Created by yangdan
 */
public class DepositeDetailTest {
    @Test
    public static void depositeDetailTest() throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://yjf3.pccb.com/api/mobile/deposite_detail");
            ...
            list.add(new BasicNameValuePair("sign_key", Md5.md5("1" + "82044"+""+"pccbYjfUserDepositeDetail" )));

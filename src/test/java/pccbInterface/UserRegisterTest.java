...
public class UserRegisterTest {
    ...
    @Test
    public static void userRegisterTest() throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://yjf3.pccb.com/appapi/user_register/");
            ...
            list.add(new BasicNameValuePair("sign_key", Md5.md5("13817506005" + "123456" )));

...
public class FeedbackTest {
    @Test
    public static void feedbackTest() throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://api.pccb.com/apitest/feedback/");
            List<NameValuePair> list = new ArrayList<NameValuePair>();
            list.add(new BasicNameValuePair("app_type","1"));
            list.add(new BasicNameValuePair("userid", Des.encryptDES("82044")));
            list.add(new BasicNameValuePair("feedback_msg","111111111111111111111111111111111111111"));
            list.add(new BasicNameValuePair("sign_key", Md5.md5( "111111111111111111111111111111111111111"+"82044"+"ProposalHelp" )));

 ...
 * Created by yangdan
 */
public class GetUserCheckInInfoTest {
    @Test
    public static void getUserCheckInInfoTest() throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://yjf3.pccb.com/appnew/get_user_check_in_info/");
            List<NameValuePair> list = new ArrayList<NameValuePair>();
            list.add(new BasicNameValuePair("app_type","1"));
            list.add(new BasicNameValuePair("userid", Des.encryptDES("82044")));
            list.add(new BasicNameValuePair("sign_key", Md5.md5("82044" + "pccbNewGetUserCheckInInfo")));

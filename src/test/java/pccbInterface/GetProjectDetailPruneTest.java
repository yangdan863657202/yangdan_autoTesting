 ...
 * Created by yangdan
 */
public class GetProjectDetailPruneTest {
    @Test
    public static void getProjectDetailPruneTest() throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://yjf3.pccb.com/appyjf/get_project_detail_prune/");
            List<NameValuePair> list = new ArrayList<NameValuePair>();
            list.add(new BasicNameValuePair("app_type","0"));
            list.add(new BasicNameValuePair("borrow_id",Des.encryptDES("5554")));
            list.add(new BasicNameValuePair("sign_key", Md5.md5( "5554" + "pccbGetProjectDetailPrune")));

 ...
 * Created by yangdan
 */
public class GetProjectInfoTest {
    @Test
    public static void getProjectInfoTest() throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://api.pccb.com/apitest/get_project_info/");
            ...
            list.add(new BasicNameValuePair("info_type",Des.encryptDES("1")));
            list.add(new BasicNameValuePair("sign_key", Md5.md5("82044.5554"  + "1" + "pccbGetProjectInfo")));

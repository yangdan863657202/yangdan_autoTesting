 ...
 * Created by yangdan
 */
public class WithdrawDetailTest {
    @Test
    public static void withdrawDetailTest () throws Exception {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://yjf3.pccb.com/api/mobile/withdraw_detail");
            ...
            list.add(new BasicNameValuePair("sign_key", Md5.md5("1" + "82044"+""+"pccbYjfUserWithdrawDetail" )));

 ...
 * Created by yangdan
 */
public class DebtTransferTest2 {
    ...
    public void signTest()throws PageElementNotException {
        ...
        WebDriverUtil.wait(driver, "/html/body/div[2]/div[1]/ul/li[2]/div/a[5]");
        driver.findElement(By.xpath("/html/body/div[2]/div[1]/ul/li[2]/div/a[5]")).click();

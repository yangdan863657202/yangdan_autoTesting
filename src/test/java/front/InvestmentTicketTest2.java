 ...
 * Created by yangdan
 */
public class InvestmentTicketTest2 {
    ...
    public void signTest()throws PageElementNotException {
        ...
        WebDriverUtil.wait(driver, "/html/body/div[2]/div[1]/ul/li[2]/div/a[3]");
        driver.findElement(By.xpath("/html/body/div[2]/div[1]/ul/li[2]/div/a[3]")).click();

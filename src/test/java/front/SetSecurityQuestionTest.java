...
public class SetSecurityQuestionTest {
    ...
    public void signTest()throws PageElementNotException {
        ...
        WebDriverUtil.getElement(driver,"//*[@id=\"container\"]/div/div[2]/div[5]/div[3]/a").click();
        WebDriverUtil.getElement(driver, "//*[@id=\"answer1\"]").sendKeys("红色");
        WebDriverUtil.getElement(driver, "//*[@id=\"answer2\"]").sendKeys("本科");
        WebDriverUtil.getElement(driver, "//*[@id=\"answer3\"]").sendKeys("马");

        WebDriverUtil.getElement(driver,"//*[@id=\"container\"]/div[2]/div[2]/div/div[8]/a[2]").click();

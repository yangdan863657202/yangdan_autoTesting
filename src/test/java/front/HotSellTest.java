...
public class HotSellTest {
    ...
    public void insuranceTest1()throws PageElementNotException {
        ...
        WebDriverUtil.sleep(1000);
        WebDriverUtil.getElement(driver, "/html/body/div[4]/div/div/div/div[2]/ul/li[1]").click();
        WebDriverUtil.sleep(1000);
        WebDriverUtil.getElement(driver, "//*[@id=\"listone\"]/table/tbody/tr[1]/td[6]/a").click();
    }
    @AfterTest

 ...
 * Created by yangdan
 */
public class IntegralDetailTest {
    ...
    public void signTest()throws PageElementNotException {
        ...
        WebDriverUtil.wait(driver, "/html/body/div[2]/div[1]/ul/li[7]/div/a[2]");
        driver.findElement(By.xpath("/html/body/div[2]/div[1]/ul/li[7]/div/a[2]")).click();

...
public class DailySignTest2 {
    ...
    public void signTest()throws PageElementNotException {
        ...
        WebDriverUtil.wait(driver, "/html/body/div[2]/div[1]/ul/li[7]/div/a[1]");
        driver.findElement(By.xpath("/html/body/div[2]/div[1]/ul/li[7]/div/a[1]")).click();

...
public class SaveMail {
    ...
    public static void depositeDetailTest() throws Exception {
        ...
        try {
            HttpPost post = new HttpPost("http://192.168.2.111:8578/service?channel=SaveMail");
            List<NameValuePair> list = new ArrayList<NameValuePair>();
            list.add(new BasicNameValuePair("account", "82044"));
            list.add(new BasicNameValuePair("mail", "1"));
            list.add(new BasicNameValuePair("platformId", "1"));

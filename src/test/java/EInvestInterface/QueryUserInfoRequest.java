...
public class QueryUserInfoRequest {
    ...
    public static void depositeDetailTest() throws Exception {
        ...
        try {
            HttpPost post = new HttpPost("http://192.168.2.111:8578/service?channel=QueryUserInfoRequest");
            List<NameValuePair> list = new ArrayList<NameValuePair>();
            list.add(new BasicNameValuePair("userId", "82044"));
